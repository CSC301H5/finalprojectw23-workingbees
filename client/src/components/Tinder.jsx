...
const  Tinder = (props) => {
  ...
  async function get_options(){
   ...
   console.log( "getOptions() line 126");

  console.log( "getOptions() line 1");
   ...
   // console.log( "asioxcall return .log and the recommentaion", recommendations);
   // console.log("res.data,questions before 2000:", res.data.questions)
     if (res.status === 200) {
    ...
    //setQuestions_array(res.data.questions);
    
    console.log("questions_array updated:", a);
    


//console.log("res.data.questions: ", questions_array)
...
for ( let index in a){
 ...
 // setDisplayComponents(prevComponents => [...prevComponents, newDisplayComponents]);
...
setDisplayComponents(prevComponents => [...prevComponents, profile]);
    ...
    useEffect( () => { 
     ...
     // console.log("useEffect: get_result")
