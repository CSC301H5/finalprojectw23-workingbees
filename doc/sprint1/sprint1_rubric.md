...
Your Mark: 3
  ...
  - Sprint Planning meeting (sprintN.md) (max 2 marks)
    ...
    Your Mark: 1.5, could go into more detail on task breakdown — who's doing what? also, did you identify any spikes?

  Planning Meetings Total Mark: 4.5 / 5
...
## Tracking on Trello  (max 20 marks) 
  ...
  - Do the pull request on GitHub match the tasks listed on Trello? (max 2 marks)
    ...
    Your Mark: 1. There should be a PR for every task. I know at this point in the project, that may seem like a lot, but it's industry standard, and good to get into the habit of small frequent PRs.
...
Your Mark: 0 (same comment as above)
...
Your Mark: 2 (just a nitpick, but git commit messages should be made in present tense)
...
Tracking on Trello Total Mark: 13 / 20
...
## Sprint Demo (Max 14 marks) 
  - Attendance (max 2 marks)
    - x2 marks = full team is present
    - 1 mark = one member is not present
    - 0 marks = more than one member is not present
  
  - Working software (max 2 marks)
    - x8 marks = All 3 features presented work flawlessly
